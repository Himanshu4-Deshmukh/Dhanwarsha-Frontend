                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="truncate font-medium text-white/80">{pay.userId?.name || 'User'}</p>
                          <p className="truncate text-xs text-white/30">{pay.userId?.email}</p>
                        </div>
                      </div>
                      <span className={`rounded-full px-2.5 py-0.5 text-xs font-semibold ${sc.bg} ${sc.text}`}>
                        {pay.status}
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      <div className="rounded-lg bg-white/5 p-3">
                        ...
                        <p className="mt-1 text-lg font-bold text-primary">{pay.amount} <span className="text-xs font-normal text-white/30">coins</span></p>
                      </div>
                      <div className="rounded-lg bg-white/5 p-3">
                        <p className="text-white/30">Date</p>
                        <p className="mt-1 text-sm text-white/70">{new Date(pay.createdAt).toLocaleDateString()}</p>
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      <button
